...
export default {
  ...
  com_ui_example_solana_one: 'Can you summarize Jupiter activity this past week on Solana?',
  com_ui_example_solana_two: 'Can you help me transfer 0.1 SOL to ngundotra.sol?',
  com_ui_example_solana_three: 'What are the best NFTs under 50 SOL?',
